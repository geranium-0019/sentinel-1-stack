...
results=[]
for case,args in [('conda-suite',['env','LD_LIBRARY_PATH=/opt/conda/lib','PYTHONPATH=/opt/conda/share/sentinel-1-stack:/opt/conda/packages:/opt/conda/share/isce2/stack','/opt/conda/bin/python','/project/tests/runtime/probe.py','suite'])]:
 for trial in range(20):
  ...
  results.append({'case':case,'trial':trial,'exit':code});(root/'conda-suite-results.json').write_text(json.dumps(results,indent=2)+'\n')
